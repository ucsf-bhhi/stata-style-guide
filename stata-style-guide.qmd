...
Add this line your `profile.do` file and it will run everytime you start Stata and the `${bhhi_shared_drive}` global variable will always be available for you. For example:
